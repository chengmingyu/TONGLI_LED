...
public class subB_ctl extends JFrame {
...
//	private team TeamB;
	...
	private static final String FILEPATH = "C:\\TONGLI\\b.txt";
	private static final String FONT_STYLE = "Microsoft YaHei";
	team TeamB = new team();
	team TeamB_Show = new team();
	subPingMu PINGMU  = new subPingMu();
	subB_show SP = new subB_show();
	int iTmp = 0;
	...
	public subB_ctl() {
		...
		// 载入球队信息
		TeamB.init();
		readManger.LoadTeam(FILEPATH, TeamB);
		//readManger.makeShowTeam(TeamB,TeamB_Show);
		//TeamB_Show = TeamB;
		makeSubPing(TeamB,PINGMU);
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if (checkPlayerNum(cb_0) == true){
					if (cb_0.getState() == true){
						...
						TeamB.player[0].setPlayerStatus(1);
					}else{
						...
						TeamB.player[0].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_1) == true) {
					if (cb_1.getState() == true) {
						...
						TeamB.player[1].setPlayerStatus(1);
					} else {
						...
						TeamB.player[1].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_2) == true) {
					if (cb_2.getState() == true) {
						...
						TeamB.player[2].setPlayerStatus(1);
					} else {
						...
						TeamB.player[2].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_3) == true) {
					if (cb_3.getState() == true) {
						...
						TeamB.player[3].setPlayerStatus(1);
					} else {
						...
						TeamB.player[3].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_4) == true) {
					if (cb_4.getState() == true) {
						...
						TeamB.player[4].setPlayerStatus(1);
					} else {
						...
						TeamB.player[4].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_5) == true) {
					if (cb_5.getState() == true) {
						...
						TeamB.player[5].setPlayerStatus(1);
					} else {
						...
						TeamB.player[5].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_6) == true) {
					if (cb_6.getState() == true) {
						...
						TeamB.player[6].setPlayerStatus(1);
					} else {
						...
						TeamB.player[6].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_7) == true) {
					if (cb_7.getState() == true) {
						...
						TeamB.player[7].setPlayerStatus(1);
					} else {
						...
						TeamB.player[7].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_8) == true) {
					if (cb_8.getState() == true) {
						...
						TeamB.player[8].setPlayerStatus(1);
					} else {
						...
						TeamB.player[8].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_9) == true) {
					if (cb_9.getState() == true) {
						...
						TeamB.player[9].setPlayerStatus(1);
					} else {
						...
						TeamB.player[9].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_10) == true) {
					if (cb_10.getState() == true) {
						...
						TeamB.player[10].setPlayerStatus(1);
					} else {
						...
						TeamB.player[10].setPlayerStatus(0);
					}
				}
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (checkPlayerNum(cb_11) == true) {
					if (cb_11.getState() == true) {
						...
						TeamB.player[11].setPlayerStatus(1);
					} else {
						...
						TeamB.player[11].setPlayerStatus(0);
					}
				}
			}
		});
		...
		JButton btnApply = new JButton("客队换人应用");
		btnApply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (iNum == 5){
					if (iStartFlg == 1){
					makeShowTeam(TeamB,TeamB_Show);
					makeSubPing(TeamB_Show,PINGMU);
					SP.getPingMu(PINGMU);
					SP.refresh();}
				}else{
		...
		btn_Goal_P_0.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				TeamB.player[0].setPlayerGoal(iTmp);
				SP.setGoal(lb_Num_0.getText(),tf_Goal_0.getText());			
				showMain.setGuestTeamPoint_P();
			}
		});
		...
		btn_Foul_P_0.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[0].setPlayerFoull(iTmp);
				SP.setFoull(lb_Num_0.getText(),getFoulToString(iTmp));		
				showMain.setGuestTeamFoul_P();
		...
		btn_Goal_P_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[1].setPlayerGoal(iTmp);
		...
		btn_Foul_P_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[1].setPlayerFoull(iTmp);
		...
		btn_Goal_P_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[2].setPlayerGoal(iTmp);
		...
		btn_Foul_P_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[2].setPlayerFoull(iTmp);
		...
		btn_Goal_P_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[3].setPlayerGoal(iTmp);
		...
		btn_Foul_P_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[3].setPlayerFoull(iTmp);
		...
		btn_Goal_P_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[4].setPlayerGoal(iTmp);
		...
		btn_Foul_P_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[4].setPlayerFoull(iTmp);
		...
		btn_Goal_P_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[5].setPlayerGoal(iTmp);
		...
		btn_Foul_P_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[5].setPlayerFoull(iTmp);
		...
		btn_Goal_P_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[6].setPlayerGoal(iTmp);
		...
		btn_Foul_P_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[6].setPlayerFoull(iTmp);
		...
		btn_Goal_P_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[7].setPlayerGoal(iTmp);
		...
		btn_Foul_P_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[7].setPlayerFoull(iTmp);
		...
		btn_Goal_P_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[8].setPlayerGoal(iTmp);
		...
		btn_Foul_P_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[8].setPlayerFoull(iTmp);
		...
		btn_Goal_P_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[9].setPlayerGoal(iTmp);
		...
		btn_Foul_P_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[9].setPlayerFoull(iTmp);
		...
		btn_Goal_P_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[10].setPlayerGoal(iTmp);
		...
		btn_Foul_P_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[10].setPlayerFoull(iTmp);
		...
		btn_Goal_P_11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[11].setPlayerGoal(iTmp);
		...
		btn_Foul_P_11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeamB.player[11].setPlayerFoull(iTmp);
		...
		JLabel lblNewLabel_1 = new JLabel("Team  B controller");
		...
		// 队员名称载入
		lb_Name_0.setText(TeamB.player[0].getPlayerName());
		lb_Name_1.setText(TeamB.player[1].getPlayerName());
		lb_Name_2.setText(TeamB.player[2].getPlayerName());
		lb_Name_3.setText(TeamB.player[3].getPlayerName());
		lb_Name_4.setText(TeamB.player[4].getPlayerName());
		lb_Name_5.setText(TeamB.player[5].getPlayerName());
		lb_Name_6.setText(TeamB.player[6].getPlayerName());
		lb_Name_7.setText(TeamB.player[7].getPlayerName());
		lb_Name_8.setText(TeamB.player[8].getPlayerName());
		lb_Name_9.setText(TeamB.player[9].getPlayerName());
		lb_Name_10.setText(TeamB.player[10].getPlayerName());
		lb_Name_11.setText(TeamB.player[11].getPlayerName());
		
		// 队员号码载入
		lb_Num_0.setText(TeamB.player[0].getPlayerNo());
		lb_Num_1.setText(TeamB.player[1].getPlayerNo());
		lb_Num_2.setText(TeamB.player[2].getPlayerNo());
		lb_Num_3.setText(TeamB.player[3].getPlayerNo());
		lb_Num_4.setText(TeamB.player[4].getPlayerNo());
		lb_Num_5.setText(TeamB.player[5].getPlayerNo());
		lb_Num_6.setText(TeamB.player[6].getPlayerNo());
		lb_Num_7.setText(TeamB.player[7].getPlayerNo());
		lb_Num_8.setText(TeamB.player[8].getPlayerNo());
		lb_Num_9.setText(TeamB.player[9].getPlayerNo());
		lb_Num_10.setText(TeamB.player[10].getPlayerNo());
		lb_Num_11.setText(TeamB.player[11].getPlayerNo());
		...
		btn_show.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if ( iStartFlg == 0){
					...
					SP.run();
					iStartFlg = 1;
					btn_show.setText("客队名单关闭");
				}else{
					SP.dispose();
					btn_show.setText("客队名单显示");
					iStartFlg = 0;
				}
			}
		});
