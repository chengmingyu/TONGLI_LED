...
public class showMain {
	...
	private static JTextField HostTeamPoint_textField;
	private static JTextField GuestTeamPoint_textField;
	private static JTextField HostTeamFoul_textField;
	private static JTextField GuestTeamFoul_textField;
	...
	static showPing SP = new showPing();
	...
	public void ClockInit() {
		...
		if (gameTime_textField.getText().length() == 1){
			SP.setClock("0"+gameTime_textField.getText() + ":00");
		}else{
	...
	public showMain() {
		initialize();
		subA_ctl subA = new subA_ctl();
		subA.setVisible(true);
		subB_ctl subB = new subB_ctl();
	...
	private void initialize() {
		...
		final String strTitle = "抚顺通力 电子计时 记分控制台            V1.0";
		frame = new JFrame();
		frame.setTitle(strTitle);
		frame.setBounds(405, 400, 425, 561);
		...
		controlText.setBounds(145, 10, 130, 27);
		...
		gameTime_textField.setBounds(12, 73, 65, 60);
		...
		gameTimePlus_button.setBounds(74, 73, 51, 30);
		...
		gameTimeCut_button.setFont(new Font("Microsoft YaHei UI", Font.PLAIN,
				12));
		gameTimeCut_button.setBounds(74, 102, 51, 30);
		...
		GameJie_label.setBounds(303, 50, 63, 13);
		...
		Jie_textField.setBounds(264, 73, 65, 60);
		...
		jiePlus_button.setBounds(326, 73, 51, 30);
		...
		jieCut_button_1.setBounds(326, 102, 51, 30);
		...
		HostTeamPoint_textField.setBounds(12, 268, 65, 60);
		...
		HostTeamPointPlus_button.setFont(new Font("Microsoft YaHei",
				Font.PLAIN, 12));
		HostTeamPointPlus_button.setBounds(74, 268, 51, 30);
		...
		HostTeamPoint_button.setFont(new Font("Microsoft YaHei UI", Font.PLAIN,
				12));
		HostTeamPoint_button.setBounds(74, 297, 51, 30);
		...
		label_2.setBounds(38, 346, 63, 13);
		...
		GuestTeamPoint_textField.setBounds(12, 369, 65, 60);
		...
		GuestTeamPointPlus_button.setFont(new Font("Microsoft YaHei",
				Font.PLAIN, 12));
		GuestTeamPointPlus_button.setBounds(74, 369, 51, 30);
		...
		GuestTeamPointCut_button.setFont(new Font("Microsoft YaHei UI",
				Font.PLAIN, 12));
		GuestTeamPointCut_button.setBounds(74, 398, 51, 30);
		...
		label_3.setBounds(171, 245, 63, 13);
		...
		HostTeamFoul_textField.setBounds(145, 268, 65, 60);
		...
		HostTeamFoulPlus_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (iTmp >= 5){
					iTmp = 5;
					SP.setHostFoulColor(1);
				}else{
					SP.setHostFoulColor(0);
				}
		...
		HostTeamFoulPlus_button.setFont(new Font("Microsoft YaHei", Font.PLAIN,
				12));
		HostTeamFoulPlus_button.setBounds(207, 268, 51, 30);
		...
		HostTeamFoulCut_button.setFont(new Font("Microsoft YaHei UI",
				Font.PLAIN, 12));
		HostTeamFoulCut_button.setBounds(207, 297, 51, 30);
		...
		label_4.setBounds(171, 346, 63, 13);
		...
		GuestTeamFoul_textField.setBounds(145, 369, 65, 60);
		...
		GuestTeamFoulPlus_button.setFont(new Font("Microsoft YaHei",
				Font.PLAIN, 12));
		GuestTeamFoulPlus_button.setBounds(207, 369, 51, 30);
		...
		GuestTeamFoulCut_button.setFont(new Font("Microsoft YaHei UI",
				Font.PLAIN, 12));
		GuestTeamFoulCut_button.setBounds(207, 398, 51, 30);
		...
		label_5.setBounds(308, 245, 63, 13);
		...
		HostTeamPause_textField.setBounds(282, 268, 65, 60);
		...
		HostTeamPausePlus_button.setFont(new Font("Microsoft YaHei",
				Font.PLAIN, 12));
		HostTeamPausePlus_button.setBounds(344, 268, 51, 30);
		...
		HostTeamPauseCut_button.setFont(new Font("Microsoft YaHei UI",
				Font.PLAIN, 12));
		HostTeamPauseCut_button.setBounds(344, 297, 51, 30);
		...
		label_6.setBounds(308, 346, 63, 13);
		...
		GuestTeamPause_textField.setBounds(282, 369, 65, 60);
		...
		GuestTeamPausePlus_button.setFont(new Font("Microsoft YaHei",
				Font.PLAIN, 12));
		GuestTeamPausePlus_button.setBounds(344, 369, 51, 30);
		...
		GuestTeamPauseCut_button.setFont(new Font("Microsoft YaHei UI",
				Font.PLAIN, 12));
		GuestTeamPauseCut_button.setBounds(344, 398, 51, 30);
		...
		ClockStopButton.setBounds(207, 453, 71, 40);
		...
		ClcokLabel.setBounds(22, 439, 96, 60);
		...
		ClockStartButton.setBounds(139, 453, 71, 40);
		...
		ClockResetButton.setBounds(276, 453, 71, 40);
		frame.getContentPane().add(ClockResetButton);

		JLabel lblNewLabel = new JLabel("版权所有 抚顺通力电子");
		lblNewLabel.setBounds(282, 491, 200, 50);
		frame.getContentPane().add(lblNewLabel);
	}

	// 主队比分增加
	public static void setHostTeamPoint_P() {
		int iTmp = Integer.valueOf(HostTeamPoint_textField.getText());
		iTmp++;
		HostTeamPoint_textField.setText(String.valueOf(iTmp));
		if (iStartFlag == 1) {
			SP.setHostPoint(HostTeamPoint_textField.getText());
	...
	// 主队比分减少
	public static void setHostTeamPoint_M() {
		int iTmp = Integer.valueOf(HostTeamPoint_textField.getText());
		iTmp--;
		if (iTmp <= 0){
			iTmp = 0;
	...
	// 主队犯规增加
	public static void setHostTeamFoul_P() {
		int iTmp;
		iTmp = Integer.valueOf(HostTeamFoul_textField.getText());
		iTmp++;
		if (iTmp >= 5){
	...
	// 主队犯规减少
	public static void setHostTeamFoul_M() {
		int iTmp;
		iTmp = Integer.valueOf(HostTeamFoul_textField.getText());
		iTmp--;
		if (iTmp <= 0){
	...
	// 客队比分增加
	public static void setGuestTeamPoint_P() {
		int iTmp = Integer.valueOf(GuestTeamPoint_textField.getText());
		iTmp++;
		GuestTeamPoint_textField.setText(String.valueOf(iTmp));
		if (iStartFlag == 1) {
			SP.setGuestPoint(GuestTeamPoint_textField.getText());
	...
	// 客队比分减少
	public static void setGuestTeamPoint_M() {
		int iTmp = Integer.valueOf(GuestTeamPoint_textField.getText());
		iTmp--;
		if (iTmp <= 0){
			iTmp = 0;
	...
	// 客队犯规增加
	public static void setGuestTeamFoul_P() {
		int iTmp;
		iTmp = Integer.valueOf(GuestTeamFoul_textField.getText());
		iTmp++;
		if (iTmp >= 5){
	...
	// 客队犯规减少
	public static void setGuestTeamFoul_M() {
		int iTmp;
		iTmp = Integer.valueOf(GuestTeamFoul_textField.getText());
		iTmp--;
		if (iTmp <= 0){
